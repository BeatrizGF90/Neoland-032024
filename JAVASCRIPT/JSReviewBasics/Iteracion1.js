...
const categoriasPelis = [];
for (palabra of movies) {
  // Primero itero sobre cada elemento del array
  for (letra of palabra.categories) {
    // Ahora itero sobre cada característica de cada elemento
    !categoriasPelis.includes(letra) && categoriasPelis.push(letra);
  }
}
console.log(categoriasPelis);
